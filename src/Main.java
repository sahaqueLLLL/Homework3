...
public class  Main {
    ...
    public static void raiseException(Integer exceptionId) throws SocketException, ClassNotFoundException, AccessDeniedException, ExportException {
        if (exceptionId == 1) {throw new SocketException("SocketException"); }
        if (exceptionId == 2) {throw new ClassNotFoundException("ClassNotFoundException");}
        if (exceptionId == 3) {throw new AccessDeniedException("AccessException");}
        if (exceptionId == 4) {throw new ExportException("ExportException");}
    }
